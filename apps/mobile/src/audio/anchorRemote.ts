...
export async function ensureFullAnchorUri(
  ...
  try {
    ...
    // Night cues must never wait on the network (Fable, L3.8 review): a cue that arrives 15 s
    // late is a cue outside the REM window. The file was prefetched at session start.
